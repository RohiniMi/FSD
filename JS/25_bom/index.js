...
function showLocation() {
    infoBox.innerHTML = `Current URL: ${location.href}<br>Protocol: ${location.protocol}<br>Hostname: ${location.hostname}`;
}
...
function showNavigatorInfo() {
    infoBox.innerHTML = `Browser Name: ${navigator.appName}<br>Browser Version: ${navigator.appVersion}<br>Platform: ${navigator.platform}`;
}
